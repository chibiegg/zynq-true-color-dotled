...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: true_color_dot_led_0, and set properties
	set true_color_dot_led_0 [ create_bd_cell -type ip -vlnv user.org:user:true_color_dot_led:1.0 true_color_dot_led_0 ]
	...
	set_property -dict [ list CONFIG.NUM_MI {2} ] $axi_peri_interconnect
	...
	# Connect all clock & reset of true_color_dot_led_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins true_color_dot_led_0/S_AXI_Control]
	connect_bd_net [get_bd_pins true_color_dot_led_0/s_axi_control_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins true_color_dot_led_0/s_axi_control_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins true_color_dot_led_0/S_AXI_Data]
	connect_bd_net [get_bd_pins true_color_dot_led_0/s_axi_data_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins true_color_dot_led_0/s_axi_data_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to true_color_dot_led_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/true_color_dot_led_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_true_color_dot_led_0_S_AXI_Control_* ]]
	puts $fp "set s_axi_control_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_true_color_dot_led_0_S_AXI_Data_* ]]
	puts $fp "set s_axi_data_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:true_color_dot_led:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/true_color_dot_led_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "true_color_dot_led_v1_0_hw_${i}"
