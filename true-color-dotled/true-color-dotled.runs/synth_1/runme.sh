...
HD_PWD='/home/chibiegg/vivado/projects/zynq-true-color-dotled/true-color-dotled/true-color-dotled.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log true_color_dot_led_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source true_color_dot_led_wrapper.tcl
